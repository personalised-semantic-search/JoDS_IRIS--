 ...
 * one.
 */
class Joiner extends BodyRuleElement {
    /**
     * Constructor.
     * 
	...
	mIndexThisLiteral = mIndexFactory.createIndex(mView,
    ...
    public Joiner(IPredicate predicate, IRelation thisLiteralsRelation,
	    ...
	    List<IVariable> outputVariables, IIndexFactory indexFactory,
	...
	return new Joiner(mPredicate, delta, mViewCriteria, mView.variables(),
		...
		mOutputVariables, mIndexFactory, mRelationFactory);
    }

...
/**
 * A floating point comparator that uses the default java behaviour. This class
 * will make floating point comparison faster, but will not allow for any
 * round-off errors at all.
 */

...
public class PreferencesTest extends TestCase {
	...
	private final Logger LOGGER = Logger.getLogger(PreferencesTest.class);
	...
	public static Test suite() {
		...
		return new TestSuite(PreferencesTest.class,
				PreferencesTest.class.getSimpleName());
	}
	...
	public void testMerge() throws Exception {
		...
		for (int nbNodes = 1000; nbNodes < 2000; nbNodes += 1000) {

			double sparisity = 0.003;

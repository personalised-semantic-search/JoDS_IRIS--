...
public class FiniteUniverseFactsTest extends TestCase {
	...
	head.add(BASIC.createLiteral(true, BASIC.createPredicate("p", 3), BASIC
		.createTuple(terms)));
	...
	body.add(BASIC.createLiteral(true, BASIC.createPredicate("p", 3), BASIC
		.createTuple(terms)));
	head.add(BASIC.createLiteral(true, BASIC.createPredicate("q", 0), BASIC
		.createTuple()));
	...
	FiniteUniverseFacts fuf = new FiniteUniverseFacts(facts,
		new ArrayList<IRule>());

...
public class TermMatchingAndSubstitutionTest extends TestCase {
	...
	assertTrue(TermMatchingAndSubstitution.match(body, relation,
		variableMap));
	...
	assertFalse(TermMatchingAndSubstitution.match(body, relation,
		variableMap));
	...
	ITuple substitutedHead = TermMatchingAndSubstitution
		.substituteVariablesInToTuple(headTuple, variableMap);

...
/**
 * 
 * Test class for TermMatchingAndSubstitution.subsums(atom1, atom2) which is
 * used by OLDT evaluation function.
 * 
 * @author gigi
...
public class SubsumsTest extends TestCase {
    ...
    private ITuple tupleXX = Factory.BASIC.createTuple(VAR_X, VAR_X);
    ...
    private ITuple tupleFX = Factory.BASIC.createTuple(Factory.TERM
	    .createConstruct("f", Factory.BASIC.createTuple(VAR_X)));

    private ITuple tupleFa = Factory.BASIC.createTuple(Factory.TERM
	    .createConstruct("f", Factory.BASIC.createTuple(STR_A)));
	...
	ILiteral lit1 = Factory.BASIC
		.createLiteral(true, predicate, emptyTuple);
	ILiteral lit2 = Factory.BASIC
		.createLiteral(true, predicate, emptyTuple);
	
	Map<IVariable, ITerm> map = new HashMap<IVariable, ITerm>();
	
	boolean actual = TermMatchingAndSubstitution.subsums(lit1.getAtom(),
		lit2.getAtom(),map);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameAritySameVariables()
	    throws ParserException {
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityRepeatedVariables()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
	ILiteral lit1 = Factory.BASIC.createLiteral(true, predicate, tupleXY);
	ILiteral lit2 = Factory.BASIC.createLiteral(true, predicate, tupleXX);
	Map<IVariable, ITerm> map = new HashMap<IVariable, ITerm>();
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityRepeatedVariablesInverse()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
	ILiteral lit1 = Factory.BASIC.createLiteral(true, predicate, tupleXX);
	ILiteral lit2 = Factory.BASIC.createLiteral(true, predicate, tupleXY);
	Map<IVariable, ITerm> map = new HashMap<IVariable, ITerm>();
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameAritySameVariablesSwitched()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
	ILiteral lit1 = Factory.BASIC.createLiteral(true, predicate, tupleXY);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityDifferentVariables()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
	ILiteral lit1 = Factory.BASIC.createLiteral(true, predicate, tupleXY);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityVariablesAndGrounded()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameAritySameConstructedTerm()
	    throws ParserException {
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityConstructedTermAndGroundedConstructedTerm()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 1);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityConstructedTermAndGrounded()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 1);
     ...
     * p(?X, ?Y). s(?X, ?Y).
     */
    public void testDifferentPredicateSameAritySameVariables()
	    throws ParserException {
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityGroundedAndVariables()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityGroundedAndConstructedTerm()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 1);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityOneGroundedAndTwoVariables()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
    ...
    /**
     * p(?X, ?Y). p('a', ?B). Same as above test, but with switched literals
     * 
     * @throws ParserException
     */
    public void testSamePredicateSameArityTwoVariablesAndOneGrounded()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityOneGroundedAndOneVariableSwitched()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityOneGroundedAndOneVariableFalse()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);
     ...
     * @throws ParserException
     */
    public void testSamePredicateSameArityOneGroundedAndOneVariableTrue()
	    throws ParserException {
	IPredicate predicate = Factory.BASIC.createPredicate("p", 2);

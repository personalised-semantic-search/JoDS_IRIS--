...
public class PreferenceParser {
    ...
    public PreferenceParser(BuiltinRegister builtinRegister) {
    }
    /**
	...
	try {
	    org.deri.iris.parser.parser.Parser parser = new org.deri.iris.parser.parser.Parser(
		    new Lexer(new PushbackReader(r, 1024)));
	    parser.parse();
	} catch (ParserException e) {
	    throw new org.deri.iris.compiler.ParserException("Parser error: "
		    + e.getMessage());
	} catch (LexerException e) {
	    throw new org.deri.iris.compiler.ParserException("Lexer error: "
		    + e.getMessage());
	} catch (IOException e) {
	    ...
	    throw new org.deri.iris.compiler.ParserException("I/O error: "
		    + e.getMessage());
